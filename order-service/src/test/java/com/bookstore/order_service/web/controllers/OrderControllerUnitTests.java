...
import static com.bookstore.order_service.testdata.TestDataFactory.createOrderRequestWithInvalidCustomer;
import static com.bookstore.order_service.testdata.TestDataFactory.createOrderRequestWithInvalidDeliveryAddress;
import static com.bookstore.order_service.testdata.TestDataFactory.createOrderRequestWithNoItems;
...
class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUserName()).willReturn("dilip");
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        given(orderService.createOrder(eq("dilip"), any(CreateOrderRequest.class)))
                .willReturn(null);
